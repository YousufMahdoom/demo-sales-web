    ...
    card.innerHTML = `
      <div>
        ...
        <div class="p-3.5 sm:p-5 space-y-3 sm:space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-1.5 sm:gap-2 py-2 border-y border-white/5">
            <div class="p-2 sm:p-2 rounded-xl bg-white/5 flex flex-row sm:flex-col items-center justify-between sm:justify-center px-3 sm:px-2">
              <span class="text-xs sm:text-[10px] uppercase font-medium text-gray-400 flex items-center gap-1.5 sm:gap-1">
                <i class="fa-regular fa-calendar text-red-400 text-xs sm:text-[10px]"></i>
                <span>Year</span>
              </span>
              <span class="text-xs sm:text-sm font-bold text-white sm:mt-0.5">${vehicle.year}</span>
            </div>
            <div class="p-2 sm:p-2 rounded-xl bg-white/5 flex flex-row sm:flex-col items-center justify-between sm:justify-center px-3 sm:px-2">
              <span class="text-xs sm:text-[10px] uppercase font-medium text-gray-400 flex items-center gap-1.5 sm:gap-1">
                <i class="fa-solid fa-gauge-high text-red-400 text-xs sm:text-[10px]"></i>
                <span>Mileage</span>
              </span>
              <span class="text-xs sm:text-sm font-bold text-white sm:mt-0.5">${vehicle.mileage}</span>
            </div>
            <div class="p-2 sm:p-2 rounded-xl bg-white/5 flex flex-row sm:flex-col items-center justify-between sm:justify-center px-3 sm:px-2">
              <span class="text-xs sm:text-[10px] uppercase font-medium text-gray-400 flex items-center gap-1.5 sm:gap-1">
                <i class="fa-solid fa-gas-pump text-red-400 text-xs sm:text-[10px]"></i>
                <span>Fuel</span>
              </span>
              <span class="text-xs sm:text-sm font-bold text-white sm:mt-0.5">${vehicle.fuel}</span>
            </div>
          </div>
