...
const HERO_SLIDES = [
  {
    badge: "FLAGSHIP PERFORMANCE SEDAN",
    brand: "BMW",
    model: "M3 COMPETITION",
    year: "2023",
    subtitle: "3.0L M TwinPower Turbo • 503 HP • xDrive",
    description: "Iconic high-performance luxury sports sedan featuring 503 HP M TwinPower Turbo inline-6 engine, intelligent xDrive AWD, and precision track dynamics.",
    tagline: '"The ultimate driving machine of extreme performance"',
    price: "Rs. 46,500,000",
    grade: "5.0 / A Verified",
    mileage: "8,500 km",
